...
var (
	ErrNotExists      = errors.New("file or directory not exists")     // 文件或目录不存在
	ErrNotPermitted   = errors.New("not permitted")                    //未被授权
	ErrEmptyDirectory = errors.New("could not delete empty directory") //无法删除空目录
)
